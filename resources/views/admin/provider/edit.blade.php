        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    @endif
                    <form action="{{route('providers.update' , $provider->id)}}" method="post" autocomplete="off">\
                        @method('PUT')
                        @csrf
                        <div class="card-body ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="email" type="email"
                                           ...
                                           placeholder="email" value="{{$provider->email}}">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="user_name" type="text"
                                           ...
                                           placeholder="Password" value="{{$provider->user_name}}">
                                    @error('user_name')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
