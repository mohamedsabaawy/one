        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    @endif
                    <form action="{{route('locations.update' , $provider->id)}}" method="post" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="longitude" type="text"
                                           ...
                                           placeholder="longitude" value="{{$provider->longitude}}">
                                    @error('longitude')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="latitude" type="text"
                                           ...
                                           placeholder="latitude" value="{{$provider->latitude}}">
                                    @error('latitude')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
